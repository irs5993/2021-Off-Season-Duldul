...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    JoystickButton pullButton = new JoystickButton(m_stick, 5);
    JoystickButton pullReverseButton = new JoystickButton(m_stick, 3);
    ...
    shootButton.whileHeld(new ShootCommand(m_shootSubsystem));
    pullButton.whileHeld(new PullCommand(m_pullSubsystem, false));
    pullReverseButton.whileHeld(new PullCommand(m_pullSubsystem, true));
